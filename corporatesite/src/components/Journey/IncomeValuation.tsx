...
import { UpdateGuestExtensionV6 } from "../../lib/cdp/cdpService";
import {
...
const IncomeValuation = ({ fields }: ContentBlockProps): JSX.Element => {
  ...
  return (
    <>
      <div className="banner">
        <img src="/journey/images/hl.jpg" alt="Home Loan" />
      </div>
...
export default withDatasourceCheck()<ContentBlockProps>(IncomeValuation);
